  ...
  const content = {
    en: {
      ...
      bookCall: {
        ...
        title1: "Ready to Supercharge",
        title2: "Your Business with AI?",
        subtitle: "Book your free consultation now and discover how AI can drive leads, save time, and boost revenue—fast, no strings attached.",
    ...
    fr: {
      ...
      bookCall: {
        ...
        title2: "Entreprise avec l'IA?",
        subtitle: "Réservez votre consultation gratuite maintenant et découvrez comment l'IA peut générer des prospects, économiser du temps et augmenter les revenus—rapidement, sans engagement.",
